...
def NumericalJacobian(U,phi=P.phi):
    ...
    for i in tqdm(range(0,(P.Nx+1)*(P.Ny+1))):
        ...
        for NJ_func in {func.Fzetas,func.Fzetac,func.Fus,func.Fuc,func.FC,func.Fh}:
    ...
    J=sp.bmat([
                [sp.csr_matrix(J11), sp.csr_matrix(J12), sp.csr_matrix(J13), sp.csr_matrix(J14),  sp.csr_matrix(J17), sp.csr_matrix(J18)],
                [sp.csr_matrix(J21), sp.csr_matrix(J22), sp.csr_matrix(J23), sp.csr_matrix(J24),  sp.csr_matrix(J27), sp.csr_matrix(J28)],
                [sp.csr_matrix(J31), sp.csr_matrix(J32), sp.csr_matrix(J33), sp.csr_matrix(J34),  sp.csr_matrix(J37), sp.csr_matrix(J38)],
                [sp.csr_matrix(J41), sp.csr_matrix(J42), sp.csr_matrix(J43), sp.csr_matrix(J44),  sp.csr_matrix(J47), sp.csr_matrix(J48)],
                [sp.csr_matrix(J71), sp.csr_matrix(J72), sp.csr_matrix(J73), sp.csr_matrix(J74),  sp.csr_matrix(J77), sp.csr_matrix(J78)],
                [sp.csr_matrix(J81), sp.csr_matrix(J82), sp.csr_matrix(J83), sp.csr_matrix(J84),  sp.csr_matrix(J87), sp.csr_matrix(J88)]
                ],format='csr')
    return J
